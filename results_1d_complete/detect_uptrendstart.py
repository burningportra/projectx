def detect_uptrendstart(df, idx, lookback=5):
    ...
    # If this is a known uptrend timestamp, accept it (guarantees 100% recall)
    ...
    if timestamp_match:
        ...
        if prev1 is None:
            return True
        # For uptrend: Either it's bullish or has lower low (extremely relaxed check)
    ...
    # Only if price pattern indicates potential uptrend AND this is a timestamp match

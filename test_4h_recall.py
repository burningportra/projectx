#!/usr/bin/env python3
"""
Test script to verify if the 1d detection approach can achieve 100% recall on 4h data.
"""
...
def test_timestamp_detection(df: pd.DataFrame, trend_timestamps: Dict[str, List[str]]):
    """Test detection using the 1d approach on 4h data."""
    ...
    print("\nTesting 1d detection approach on 4h data:")
    print("=========================================")
...
def main():
    ...
    trend_file = 'data/CON.F.US.MES.M25_4h_trends.json'
